...
import com.example.bootweb.websocket.listener.STOMPConnectEventListener;
import com.example.bootweb.websocket.profile.WebSocketToUserDemo;

@Configuration
@EnableWebSocketMessageBroker
@WebSocketToUserDemo
public class WebSocketToUserConfig extends AbstractWebSocketMessageBrokerConfigurer {
  ...
  public void registerStompEndpoints(StompEndpointRegistry registry) {
    registry.addEndpoint("/websocket-server-endpoint") // 表示添加了一个socket端点，客户端就可以通过这个端点来进行连接。
