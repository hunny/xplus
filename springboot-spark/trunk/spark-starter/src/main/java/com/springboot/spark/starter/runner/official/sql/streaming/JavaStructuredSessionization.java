 ...
 * sql.streaming.JavaStructuredSessionization localhost 9999`
 */
...
public final class JavaStructuredSessionization {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SparkSession spark = SparkSession.builder().appName("JavaStructuredSessionization")
        .getOrCreate();
    ...
    Dataset<Event> events = lines.withColumnRenamed("value", "line")
    ...
    MapGroupsWithStateFunction<String, Event, SessionInfo, SessionUpdate> stateUpdateFunc = new MapGroupsWithStateFunction<String, Event, SessionInfo, SessionUpdate>() {
      ...
      public SessionUpdate call(String sessionId, Iterator<Event> events,
        ...
        if (state.hasTimedOut()) {
          ...
          return new SessionUpdate(sessionId, state.get().calculateDuration(),
    ...
    StreamingQuery query = sessionUpdates.writeStream().outputMode("update").format("console")
        .start();
