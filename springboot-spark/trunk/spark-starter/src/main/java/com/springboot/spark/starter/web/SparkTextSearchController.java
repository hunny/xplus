...
import com.springboot.spark.starter.service.TextSearchSparkService;

@RestController
@SparkTextSearch
public class SparkTextSearchController extends SparkController {

  @Autowired
  private TextSearchSparkService textSearchSparkService;

  @RequestMapping("/text/search")
  public ResponseEntity<List<String>> textSearch() {
    return new ResponseEntity<>(textSearchSparkService.search(), HttpStatus.OK);
  }
  ...
  public ResponseEntity<Map<String, String>> about() {
    ...
    map.put("application.active", "SparkTextSearch");
